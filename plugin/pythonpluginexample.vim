...
exe "function Pendejada1()\necho 'perras mamadas con el vim'|echo 22|call system('neofetch')\nendfunction"
exe "func Bar1()\necho 1\nendfunc"
exe "func Foo1()\necho 'foo'\nendfunc"

exe "function Suma1(num1, num2) \n  echo num1 + num2 \n endfunction"
python3 from testlibrs.Executions import hello_world
python3 from testlibrs.Executions import MiPluginFuncion
" python3 testlibrs.Executions.hello_world()
